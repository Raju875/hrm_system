...
@section('content')
    ...
    <div class="right_col" role="main">
        ...
        <div class="col-md-8" style="margin:50px 0px 0px 100px">
            <h1 class="box-title text-center">Employee Resign Form</h1>
            <hr>
            <!-- Horizontal Form -->
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 col-md-offset-3">
                        <form role="form" method="post" action="{{ url('/user/submit-resign-form') }}">
                            ...
                            <div class="row">
                                <div class="col-sm-12 form-group">
                                    <label for="email"> Resigning Date:</label>
                                    <input type="date" class="form-control"  name="resigning_date" maxlength="50">
                                    <span style="color: #c41c41">{{ $errors->has('resigning_date') ? $errors->first('resigning_date') : ' ' }}</span>
                            ...
                            <div class="row">
                                <div class="col-sm-12 form-group">
                                    ...
                                    <textarea class="form-control" type="textarea"  name="reason"  placeholder="Write here to reason of resigning" maxlength="6000" rows="7"></textarea>
