...
@section('body')
    ...
    <div class="right_col" role="main">
        ...
        <div class="col-md-8" style="margin:50px 0px 0px 100px">
            ...
            <form action="{{ url('/payroll/view-advance-employee') }}" method="post">
                {{ csrf_field() }}
                <br>
                <div class="form-horizontal">
                    <select class="form-control" name="employee_official_id">
                        @foreach($advanceEmployees as $advanceEmployees)
                            <option value="{{ $advanceEmployees->employee_official_id }}">{{ $advanceEmployees->employee_official_id }} </option>"
                        @endforeach
