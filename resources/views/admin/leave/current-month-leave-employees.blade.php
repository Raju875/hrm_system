                        ...
                        <div class="box-body">
                            <table id="example2" class="table table-bordered table-hover">
                                ...
                                @foreach($leaveEmployees as $leaveEmployee)
                                    <tr>
                                        <td>{{ $count }}</td>
                                        <td>{{ $leaveEmployee->employee_official_id }}</td>
                                        <td>{{ $leaveEmployee->submitted_date }}</td>
                                        <td>{{ $leaveEmployee->leave_starting_date }}</td>
                                        <td>{{ $leaveEmployee->leave_ending_date }}</td>
                                        <td>{{ $leaveEmployee->intervals }}</td>
                                    <?php $count++ ?>
                                @endforeach
                                </tbody>
                            </table>
